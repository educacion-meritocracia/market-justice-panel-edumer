...
```{r results='asis'}
reg0 <- lm(perc_des~ola, data=data)
...
reg4<- lm(perc_des~ola+perc_esfuerzo_soc+perc_talento_soc+perc_merit_soc+pref_esfuerzo_soc+pref_talento_soc+perc_esfuerzo_esc+perc_talento_esc+perc_merit_esc,data=data)
