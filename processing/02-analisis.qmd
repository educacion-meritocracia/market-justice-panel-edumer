...
```{r results='asis'}
reg0 <- lm(perc_des~ola+curso_estudiante_rec, data=data)
reg1.1<- lm(perc_des~perc_esfuerzo_soc,data=data)
reg1.2<- lm(perc_des~perc_talento_soc,data=data)
reg1.3<- lm(perc_des~perc_merit_soc,data=data)
reg1<- lm(perc_des~perc_esfuerzo_soc+perc_talento_soc+perc_merit_soc,data=data)
reg2.1<- lm(perc_des~pref_esfuerzo_soc,data=data)
reg2.2<- lm(perc_des~pref_talento_soc,data=data)
reg2<- lm(perc_des~pref_esfuerzo_soc+pref_talento_soc,data=data)
reg3.1<- lm(perc_des~perc_esfuerzo_esc,data=data)
reg3.2<- lm(perc_des~perc_talento_esc,data=data)
reg3.3<- lm(perc_des~perc_merit_esc,data=data)
reg3<- lm(perc_des~perc_esfuerzo_esc+perc_talento_esc+perc_merit_esc,data=data)
reg4<- lm(perc_des~ola+curso_estudiante_rec+perc_esfuerzo_soc+perc_talento_soc+perc_merit_soc+perc_padres_ricos+perc_contactos+pref_esfuerzo_soc+pref_talento_soc+pref_padres_ricos+pref_contactos+perc_esfuerzo_esc+perc_talento_esc+perc_merit_esc,data=data)
